...
<form action="saveBoard" method="post" id="frm">
		<div class="board_insert_wrap">
			<div class="board_insert">
				<div class="title">
					<dl>
						<dt>제목</dt>
						<dd><input type="text" name="postTitle" id="adminT" placeholder="제목 입력" ></dd>
					</dl>
				</div>				
				<div class="info">
					<dl>
					...
					<dl>
						<dt>비밀번호</dt>
						<dd><input type="password" name="postPass" id="adminPass" placeholder="비밀번호 입력" ></dd>
					</dl>
					
				</div>				
				<div class="cont">
					<textarea name="postContent" id="adminC"  placeholder="내용 입력"></textarea>
				</div>				
			</div>
		</div>
		...
		<div class="bt_wrap">
			<button type="button" class="writePost" id="insertBtn" >등록</button>
