    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>We are a team of talented developers making 국비지원교육 more accessible to you</h2>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="../resources/assets/img/hero-img.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              	We, the Soupie Family, are a team of talented junior developers who studied and completed a full-stack course through 국비교육지원 시스템.
